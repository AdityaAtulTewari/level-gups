...
END {print "Latency Vector\t" L1,L2,L3,LM}
END {print "Unexplained Variance\t" UnV}
...
END {LP = 100}
END {print "PIM_ep_mem_cycles\t" LP, dtlb_me *  LP/cycles * 100}
END {print "PIM_ep_saved\t" LP, dtlb_me * (LM - LP) /cycles * 100}
END {LP = 200}
END {print "PIM_ep_mem_cycles\t" LP, dtlb_me *  LP/cycles * 100}
END {print "PIM_ep_saved\t" LP, dtlb_me * (LM - LP) /cycles * 100}
END {LP = 300}
